...
namespace Splitty.Infrastructure.Migrations
{
    ...
    [Migration("20260922135349_Add_Simplified_Debts")]
    partial class Add_Simplified_Debts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Splitty.Domain.Entities.Balance", b =>
                {
                    ...
                    b.HasIndex("GroupId", "UserId", "PeerId");
            ...
            modelBuilder.Entity("Splitty.Domain.Entities.Group", b =>
                {
                    ...
                    b.Property<bool>("BalancesPending")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Splitty.Domain.Entities.Invite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Splitty.Domain.Entities.SimplifiedDebt", b =>
                {
                    ...
                    b.HasKey("GroupId", "FromUserId", "ToUserId");

                    b.HasIndex("FromUserId");

                    b.HasIndex("ToUserId");

                    b.ToTable("SimplifiedDebt");
                });
            ...
            modelBuilder.Entity("Splitty.Domain.Entities.SimplifiedDebt", b =>
                {
                    b.HasOne("Splitty.Domain.Entities.User", "FromUser")
                        .WithMany()
                    ...
                    b.HasOne("Splitty.Domain.Entities.User", "ToUser")
                        .WithMany()
